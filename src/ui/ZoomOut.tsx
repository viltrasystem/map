...
const ZoomOut: React.FC<ZoomOutProp> = ({ setZoom }: ZoomOutProp) => {
  ...
  return (
    <button
      ...
      className="rounded-full p-[4px] w-8 h-8 flex items-center justify-center text-gray-800 dark:text-gray-800  hover:text-gray-100 dark:hover:text-gray-100 hover:bg-gray-400 dark:hover:bg-gray-600  dark:hover:ring-gray-600  transition duration-300"
    >
