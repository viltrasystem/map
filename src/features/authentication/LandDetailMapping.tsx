...
const LandDetailMapping: React.FC = () => {
  ...
  const validateLandDetail = (parsedParams: Record<string, number>) => {
  ...
  const validationCallbacks = {
    land_detail: validateLandDetail,
  };
...
export default LandDetailMapping;
