  ...
  new TileLayer({
    source: new TileWMS({
      ...
      params: {
        ...
        VERSION: "1.1.0",
        REQUEST: "GetMap",
        LAYERS: "base:sjokartraster", // Layer name
...
export default SjokartrasterLayer;

//http://localhost:8080/geoserver/base/wms?service=WMS&version=1.1.0&request=GetMap&layers=base%3Asjokartraster&bbox=-1.2645686342253646E7%2C-2.3583545928003695E7%2C1.4361008310400637E7%2C2.611837501148252E7&width=417&height=768&srs=EPSG%3A3857&styles=&format=image%2Fpng
